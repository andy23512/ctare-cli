...
var selection = {};
var projectTemplateFolder = path_1.default.normalize(path_1.default.join(__dirname, '../project'));
var projectName = '';
var vueVersion;
...
function getProjectSetting() {
    ...
    if (vueVersion === '2') {
        projectTemplateFolder = path_1.default.join(projectTemplateFolder, 'vue2');
    }
    else if (vueVersion === '3') {
        projectTemplateFolder = path_1.default.join(projectTemplateFolder, 'vue3');
    }
    else {
...
function copyFiles() {
    ...
    child_process_1.default.execSync("cp " + projectTemplateFolder + "/vue.config.js .");
    child_process_1.default.execSync("cp -rf " + projectTemplateFolder + "/src .");
    child_process_1.default.execSync("cp -rf " + projectTemplateFolder + "/public/index.html ./public/");
    if (!hasRouter) {
    ...
    if (selection.plugin.storybook) {
        child_process_1.default.execSync("cp -rf " + projectTemplateFolder + "/storybook .");
